...
This Monokai Pro Community Edition (CE) theme is maintained by [PushkaCom](https://github.com/pushkacom) and is based on the original [Monokai Pro](https://monokai.pro) theme.
